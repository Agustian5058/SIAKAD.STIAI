...
<input type=button value='Input KRS' onclick=location.href='?module=krs&act=carimatakul'>
...
$tampil=mysql_query("SELECT b.nmmatkul,c.kdjur,c.nmjur,d.nim,d.nama,a.* from matakuliah b,jurusan c,mahasiswa d,krs a WHERE b.kdmatkul=a.kdmatkul AND c.kdjur=a.kdjur AND d.nim=a.nim AND a.nim='$_SESSION[namauser]' ORDER BY a.nim");
...
echo "</table>";
$tampil2 = mysql_query("SELECT b.nmmatkul,c.kdjur,c.nmjur,d.nim,d.nama,a.* from matakuliah b,jurusan c,mahasiswa d,krs a WHERE b.kdmatkul=a.kdmatkul AND c.kdjur=a.kdjur AND d.nim=a.nim AND a.nim='$_SESSION[namauser]'");
...
<form method=POST action='$aksi?module=krs&act=input'>
	...
	//mysql_query("INSERT INTO krs_temp(nim,tahun,kdjur)
	//			VALUES('$nima','$tahuna','$kdjura')");
	...
	//$kdmatkula=$r[kdmatkul];
	//	$nmmatkula=$r[nmmatkul];
	//	$sksa=$r[sks];
	//	$kdkelasa=$r[kdkelas];
	//	$semestera=$r[semester];
	//$a = $r[semester] % 2;
	//if ($a == 1) {/
    //$ket = "Ganjil";
//} else {
  //  $ket = "Genap";
//}
	//	mysql_query("INSERT INTO krs_temp(nim,tahun,kdjur,kdmatkul,nmmatkul,sks,kdkelas,semester,ket)
	//				VALUES('$nima','$tahuna','$kdjura','$kdmatkula','$nmmatkula','$sksa','$kdkelasa','$semestera','$ket')");
//	}
		
	//$ktemu=mysql_num_rows($tampilmatakul);
	//if ($ktemu > 0) {
		echo "<table>
					<tr>
	...
	//	$tampilkrs=mysql_query("SELECT * FROM krs_temp ORDER BY semester");			
