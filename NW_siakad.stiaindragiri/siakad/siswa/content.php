...
if ($_GET[module]=='home') {
	echo "<h2>Login Mahasiswa</h2>
		...
		<tr>
		  <td width=120 align=center><a href=index.php?module=mahasiswa><img src=images/user.jpg border=none></a></td>
		  <td width=120 align=center><a href=index.php?module=nilai><img src=images/modul.png border=none></a></td>
		  <td width=120 align=center><a href=index.php?module=krs><img src=images/berita.png border=none></a></td>
		  <td width=120 align=center><a href=index.php?module=jadwal><img src=images/komentar.png border=none></a></td>
    </tr>
		<tr>
		  <th width=120><b>Data Saya</b></th>
		  <th width=120><b>Lihat Nilai</b></center></th>
		  <th width=120><b>Isi KRS</b></th>
