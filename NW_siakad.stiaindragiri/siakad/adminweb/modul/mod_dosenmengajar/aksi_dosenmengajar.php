...
if ($ketemu > 0) {
	...
	mysql_query("INSERT INTO dosemengajar(kode_dosen,kdmatkul,dosenlain,jumlahtatapmuka,semester,kdjur,tahun) 
			VALUES('$_POST[kode_dosen]',
					'$_POST[kdmatkul]',
					'$_POST[dosenlain]',
					'$_POST[jumlahtatapmuka]',
					'$_POST[semester]',
					'$_POST[kodejur]',
					'$_POST[tahun]')");
...
mysql_query("UPDATE dosemengajar SET dosenlain='$_POST[dosenlain]',
									jumlahtatapmuka='$_POST[jumlahtatapmuka]'
