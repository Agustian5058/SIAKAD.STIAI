...
<input type=button class='btn btn-primary' value='Tambah Mahasiswa' onclick=\"window.location.href='?module=mahasiswa&act=tambahmahasiswa';\">
...
$tampil=mysql_query("SELECT * FROM mahasiswa,jurusan WHERE mahasiswa.kdjur=jurusan.kdjur ORDER BY nim ");
$no=$posisi+1;
while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				<a href=$aksi?module=mahasiswa&act=hapus&id=$r[nim]>Hapus</a></td>
			</tr>";
	$no++;
}
echo "</table>";
...
<tr>
	...
	combotgl(1980,$thn_skrg,'tahun',$thn_skrg);
echo "</td>
</tr>
<tr>
	<td>Jenis Kelamin</td>
...
<tr>
	...
	$thn_skrg=date("Y");
	combotgl2(1980,$thn_skrg,'angkatan',$get_thn);
echo "</td>
</tr>
<tr>
	<td>Foto</td>
...
<tr>
	...
	$thn_skrg=date("Y");
	combotgl2(1980,$thn_skrg,'tahun',$get_thn);
...
<tr>
	...
	$thn_skrg=date("Y");
	combotgl2(1980,$thn_skrg,'thlulus',$get_thn);
