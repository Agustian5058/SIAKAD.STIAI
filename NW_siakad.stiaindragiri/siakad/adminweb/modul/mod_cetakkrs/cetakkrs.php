...
$pdf->addPngFromFile('kopsurat2.png', 15, 775, 555);
...
$sql = mysql_query("SELECT * FROM krs k, jurusan j, mahasiswa m WHERE k.nim = m.nim AND m.kdjur = j.kdjur AND k.nim='$_POST[nim]' AND k.tahun='$_POST[tahun]' AND k.ket='$_POST[semester]' ORDER BY k.kdmatkul");
